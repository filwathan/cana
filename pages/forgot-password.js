            ...
            <div className='min-w-screen min-h-screen grid grid-cols-[800px_minmax(640px,_1fr)]'>
                ...
                <div className='px-20'>
                    ...
                    <div className='w-[493px] pt-5'>
                        <p className='text-[#3A3D4299] text-lg leading-8'>To reset your password, you must type your e-mail and we will send a link to your email and you will be directed to the reset password screens.</p>
                    </div>
                    ...
                    <form>
                        ...
                        <div className='pt-16 flex justify-center pr-10'>
                            <button className="btn btn-wide text-center w-[510px] h-12 border rounded-md bg-[#6379F4] text-white font-semibold" type='submit'>Confirm</button>
                        </div>
                    </form>
                </div>
            </div>
