...
const Register = () => {
    ...
    const handleSubmit = (value) => {
        ...
        dispatch(registerAction({ firstName, lastName, email, password, cb: () => router.push("/create-pin") }));
      };
                            ...
                            <Form>
                                <div className="flex flex-col gap-8 mb-5">
                                    <div className='border-b-2 flex gap-5 py-3 items-center '>
                                        <Icon.User className=''/>
                                        <Field className='flex-1 focus:outline-none px-1' type="text" name="firstName" placeholder="Enter your first name" />  
                                    </div>
                                    {errors.firstName && touched.firstName ? (<div className="text-red-500">{errors.firstName}</div>) : null}
                                    <div className='border-b-2 flex gap-5 py-3 items-center '>
                                        <Icon.User className=''/>
                                        <Field className='flex-1 focus:outline-none px-1' type="text" name="lastName" placeholder="Enter your lastName" />  
                                    </div>
                                ...
                                <div className='pb-10'>
                                    <button className="btn text-center border rounded-md bg-[#1d2817] w-full" type='submit'>Register</button>
                                </div>
                                <div className='flex justify-center gap-5'>
                                    <p>Already have an account? Let’s </p>
                                    <Link href='/login'> <p className='text-[#1d2817]'>Login</p></Link>
                                </div>
                            </Form>
